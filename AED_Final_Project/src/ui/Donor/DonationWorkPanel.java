...
public class DonationWorkPanel extends javax.swing.JPanel {
     ...
     */
    public DonationWorkPanel(JPanel userProcessContainer, UserAcc userAccount, ConfSetup ecoSystem) {
        initComponents();
    ...
    protected void paintComponent(Graphics g) {
      ...
      private void addInputVerifiers() {
        InputVerifier noValidation = new ValidateNo();
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
       ...
       donation.setAccntNumber(cardNumberField.getText());
           ...
           try
           {
           donationTask donationRequest = new donationTask();
    ...
    public UserAcc getHeartHelpManagerAccnt()
    {
        try
        {
        Supervisor supervisorOrganization = (Supervisor)Validations.getSupervisorOrganization(ecoSystem, userAccount);
        UserAcc mngrAccnt = null;
        ...
        for(UserAcc ua : supervisorOrganization.getUserAccountDirectory().getUserAccountList())
        {
