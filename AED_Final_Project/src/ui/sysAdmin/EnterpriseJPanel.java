...
public class EnterpriseJPanel extends javax.swing.JPanel {
     ...
     */
    public EnterpriseJPanel(JPanel userProcessContainer, ConfSetup system) {
        initComponents();
    ...
    private void populateComboBox() {
        ...
        for (Enterprises.EnterpriseType type : Enterprises.EnterpriseType.values()) {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Enterprises.EnterpriseType type = (Enterprises.EnterpriseType) enterpriseTypeJComboBox.getSelectedItem();
        ...
        Enterprises enterprise = network.getEnterpriseDirectory().addEnterprise(name, type);
    ...
    private void deleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteNetworkActionPerformed
        Enterprises entToBeDeleted = null;
        ...
        if(selectedRow >= 0)
        {
            ...
            {
                Enterprises enterprise = (Enterprises)enterpriseJTable.getValueAt(selectedRow, 0);
                for (Coverage network : system.getNetworkList())
                {
                    for (Enterprises e : network.getEnterpriseDirectory().getEnterpriseList())
                    {
