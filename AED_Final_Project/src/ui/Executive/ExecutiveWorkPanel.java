...
import backend.organizations.Mayor;
...
public class ExecutiveWorkPanel extends javax.swing.JPanel {
    ...
    private Mayor mayorOrganization;
 ...
 //   private HelpSeekerOrganization helpSeekerOrg;
     ...
     */
    public ExecutiveWorkPanel(JPanel userProcessContainer, UserAcc userAccount, Organization organization, ConfSetup ecoSystem ) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.ecoSystem = ecoSystem;
        this.userAccount = userAccount;
        this.mayorOrganization = (Mayor)organization;
    ...
    public OrganizationSeeker getHelpSeekerOrg()
    {
        OrganizationSeeker helpSeekerOrg = null;
        ...
        for(Coverage network : ecoSystem.getNetworkList())
        {
         if(network.equals(userAccount.getNetwork()))
         {
          for(Enterprises enterprise : network.getEnterpriseDirectory().getEnterpriseList())
          {
            ...
            {
             if(organization instanceof OrganizationSeeker)
             {
              helpSeekerOrg = (OrganizationSeeker)organization; 
             }
            }
            }
          }
    ...
    public HashMap<String,Integer> getHelpSeekerData()
    {
        ...
        OrganizationSeeker helpSeekerOrganization = getHelpSeekerOrg();
    ...
    private void viewDetailedRprtMayorBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailedRprtMayorBtnActionPerformed
        ...
        DisplayReportExecutivePanel viewDetailedReportMayorJPanel = new DisplayReportExecutivePanel(userProcessContainer, communitydetailsmap);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("DisplayReportExecutivePanel", viewDetailedReportMayorJPanel);
