 ...
 * @author keert
 */
public class detailedviewreport extends javax.swing.JPanel {
    private List<Entry<String, Integer>> topVolunteeerList;
     private List<Entry<String, Integer>> topDonorList;
     private JPanel userProcessContainer;

    /**
     * Creates new form detailedviewreport
     */
    public detailedviewreport(JPanel userProcessContainer, List<Entry<String, Integer>> topVolunteeerList, List<Entry<String, Integer>> topDonorList) {
        initComponents();
