 ...
 * @author Keerthi
 */
public class workareaforhelpseeker extends javax.swing.JPanel {
    ...
    /**
     * Creates new form workareaforhelpseeker
     */
    public workareaforhelpseeker(JPanel userProcessContainer, Enterprise enterprise , UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void manageHelpSeekerProfileActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    private void writeTestimonialForVolBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                          
    ...
    private void manageHelpFromVolunteerActionPerformed(java.awt.event.ActionEvent evt) {                                                        
