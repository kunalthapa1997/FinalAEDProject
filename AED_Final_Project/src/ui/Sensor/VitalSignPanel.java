...
import backend.enterprises.NgoEnterprise;
...
public class VitalSignPanel extends javax.swing.JPanel {
     ...
     */
    public VitalSignPanel(JPanel userProcessContainer, UserAcc userAccount, ConfSetup ecoSystem) {
        initComponents();
    ...
    private void submitVitalSignsJBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitVitalSignsJBtnActionPerformed
     ...
     if(person.isShareVitalInfo() && person.isHasSensorDevice())
     {
       ...
       if(person.isShareVitalInfo() && !person.isHasSensorDevice())
       {
        ...
        DeviceTask nsdwr = new DeviceTask();
