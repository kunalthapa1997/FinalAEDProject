...
public class TestimonialForVolunteerPanel extends javax.swing.JPanel {
     ...
     */
    public TestimonialForVolunteerPanel(JPanel userProcessContainer, UserAcc userAccount) {
        initComponents();
    ...
    public void populateHelpReqJTable()
    {
      DefaultTableModel dtm = (DefaultTableModel)helpRequestsJTable.getModel();
        ...
        for(TaskRequest workRequest : userAccount.getWorkQueue().getWorkRequestList())
        {
            ...
            {
           HelpTask helpWorkRequest = (HelpTask)workRequest; 
    ...
    private void writeTestimonialBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_writeTestimonialBtnActionPerformed
        ...
        HelpTask nhwr = (HelpTask)helpRequestsJTable.getValueAt(selectedRow, 1);
    ...
    private void submitTestimnialBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitTestimnialBtnActionPerformed
        ...
        Test testimonial = volunteer.addTestimonial();
