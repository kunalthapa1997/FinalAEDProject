...
public class HelpByVolunteerPanel extends javax.swing.JPanel {
     ...
     */
    public HelpByVolunteerPanel(JPanel userProcessContainer, UserAcc userAccount, ConfSetup ecoSystem) {
        initComponents();
    ...
    private void createRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRequestButtonActionPerformed
       ...
       else
       {
        ...
        needHelp = (HelpRequired)helpListJTable.getValueAt(selectedRow, 0);
       }
       ...
       try
        ...
        HelpTask needHelpWorkRequest = new HelpTask();
