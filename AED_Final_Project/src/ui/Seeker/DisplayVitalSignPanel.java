...
public class DisplayVitalSignPanel extends javax.swing.JPanel {
     ...
     */
    public DisplayVitalSignPanel(JPanel userProcessContainer, UserAcc userAccount, UserAccDir userAccountDirectory) {
        initComponents();
    ...
    {   
        ...
        int age = Validations.calculateAge(person.getDob());
