...
public class FindVolunteerPanel extends javax.swing.JPanel implements JMapViewerEventListener{
     ...
     */
    public FindVolunteerPanel(JPanel userProcessContainer, UserAcc userAccount, ConfSetup ecoSystem) {
        initComponents();
    ...
    ICoordinate iCoordinate = new Coordinate(42.2875968, -71.0794968);
      ...
      {
       for(UserAcc volunteerAccnt : volOrg.getUserAccountDirectory().getUserAccountList())
       {
    ...
    public void populateVolunteerListTable(Coverage network)
    {
        ...
        try
        {
        volOrg = (Volunteers)Validations.getVolunteerOrganizationInNw(ecoSystem, network);
        }
        catch(Exception e)
        {
    ...
    private void networkListComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_networkListComboBoxActionPerformed
       ...
       {
            Coverage network = (Coverage)networkListComboBox.getSelectedItem();
