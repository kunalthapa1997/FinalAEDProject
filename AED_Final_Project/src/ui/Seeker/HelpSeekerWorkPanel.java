...
public class HelpSeekerWorkPanel extends javax.swing.JPanel {
     ...
     */
    public HelpSeekerWorkPanel(JPanel userProcessContainer, Enterprises enterprise , UserAcc userAccount, ConfSetup ecoSystem) {
        initComponents();
       ...
       for(TaskRequest request : userAccount.getWorkQueue().getWorkRequestList())
        {
            ...
            if(count<5)
            {
            DataToDoctorTask dataToDoctorWorkRequest = (DataToDoctorTask)request;
            ...
            if(count<5)
            {
             DeviceTask needSensorDeviceWorkRequest = (DeviceTask)request;
    ...
    private void manageHelpFromVolunteerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageHelpFromVolunteerActionPerformed
        HelpFromVolunteer manageHelpFromVolunteer = new HelpFromVolunteer(userProcessContainer, userAccount, ecoSystem, enterprise);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
