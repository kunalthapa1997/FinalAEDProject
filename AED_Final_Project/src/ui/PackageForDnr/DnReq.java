 ...
 * @author swati
 */
public class DnReq extends javax.swing.JPanel {
private JPanel userProcessContainer;
    private EcoSystem ecoSystem;
    private UserAccount userAccount;
    private DonorOrganization donorOrganization;
    /**
     * Creates new form DnReq
     */
    public DnReq(JPanel userProcessContainer, UserAccount userAccount, Organization organization, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void viewAndUpdateProfileBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                        
       int selectedRow = workRequestJTable.getSelectedRow();
