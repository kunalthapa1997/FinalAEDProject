 ...
 * @author keert
 */
public class Mworkarea extends javax.swing.JPanel {
    ...
    /**
     * Creates new form Mworkarea
     */
    public Mworkarea(JPanel userProcessContainer, UserAccount userAccount, Organization organization, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void viewDetailedRprtMayorBtnActionPerformed(java.awt.event.ActionEvent evt) {                                                         
          if(communitydetailsmap.isEmpty() || communitydetailsmap == null)
         {
        JOptionPane.showMessageDialog(null, " No Data to display as of now!","warning", JOptionPane.WARNING_MESSAGE);
        return;      
