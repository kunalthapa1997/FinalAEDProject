...
import backend.shared.VolunteerLocation;
...
public class SuperProcessRequestPanel extends javax.swing.JPanel {
    ...
    private SupervisorTask request;
    private ConfSetup ecoSystem;
    /**
     * Creates new form SupervisorWorkRequestAreaJPanel
     */
    public SuperProcessRequestPanel(JPanel userProcessContainer, SupervisorTask request, ConfSetup ecoSystem) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.request = request;
        this.ecoSystem = ecoSystem;
        resultComboBox.removeAllItems();
        resultComboBox.addItem(SupervisorTask.REQUEST_APPROVED);
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        SuperActionAreaPanel supervisorWorkAreaJPanel = (SuperActionAreaPanel) component;
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Coverage net = (Coverage)assignNetworkCombo.getSelectedItem();
        ...
        String[] longlat = VolunteerLocation.getLatLongForVolunteer(net.getCity());
        ...
        if(request.getTestResult().equals(SupervisorTask.REQUEST_APPROVED))
        {
        ...
        emailMsgTxt.append("HeartHelp");
             ...
             boolean emailSent = SendMail.sendEmail(emailMsgTxt.toString(),emailId,userName, password);
                    if(!emailSent)
                   {
