...
public class SuperActionAreaPanel extends javax.swing.JPanel {
    ...
    private Supervisor supervisorOrganization;

    /**
     * Creates new form SupervisorWorkAreaJPanel
     */
    public SuperActionAreaPanel(JPanel userProcessContainer, UserAcc userAccount, Organization organization, ConfSetup ecoSystem ) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.ecoSystem = ecoSystem;
        this.userAccount = userAccount;
        this.supervisorOrganization = (Supervisor)organization;
    ...
    public void populateWorkRequestTable()
    {
        ...
        for(TaskRequest request : supervisorOrganization.getWorkQueue().getWorkRequestList()){
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        SupervisorTask request = (SupervisorTask)workRequestJTable.getValueAt(selectedRow, 0);
        if(request.getReceiver() == null)
        {
        ...
        SuperProcessRequestPanel swrajp = new SuperProcessRequestPanel(userProcessContainer, request, ecoSystem);
    ...
    private void updateSupervisorProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateSupervisorProfileActionPerformed
       MakeSupervisorProPanel createSupervisorProfileJPanel = new MakeSupervisorProPanel(userProcessContainer, userAccount);
         CardLayout layout = (CardLayout) userProcessContainer.getLayout();
