...
public class ManageEmpPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ManageEmpPanel
     */
    public ManageEmpPanel(JPanel userProcessContainer,OrgDir organizationDir) {
        initComponents();
    ...
    private void populateEmployeeAndPeopleTable(Organization organization){
       ...
       if (organization.getName().equals("HelpSeeker Organization"))
        {
           for(Seeker person : organization.getPersonDirectory().getCustomerLsit()){
