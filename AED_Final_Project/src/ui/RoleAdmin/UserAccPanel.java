 ...
 * @author kunal
 */
public class UserAccPanel extends javax.swing.JPanel {
     ...
     */
    public UserAccPanel(JPanel container, Enterprises enterprise, UserAcc userAccount) {
        initComponents();
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        try
        {
            ...
            UserAcc account = organization.getUserAccountDirectory().addUserAccount(userName, password, person, role);
            account.setNetwork((Coverage)userAccount.getNetwork());
