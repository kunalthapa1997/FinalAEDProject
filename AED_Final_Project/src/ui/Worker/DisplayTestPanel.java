...
public class DisplayTestPanel extends javax.swing.JPanel {
     ...
     */
    public DisplayTestPanel(JPanel userProcessContainer, UserAcc userAccount) {
        initComponents();
    ...
    public void populateTestimonialsDynamically()
    {
       ...
       int pos = 0;
        ...
        for(Test testimonial : volunteer.getTestimonialList())
        {
            if(count<5)
            {
    ...
    private void initComponents() {
        ...
        viewTestiBtn.setText("Show Feedback");
    ...
    private void viewTestiBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewTestiBtnActionPerformed
        ...
        if(selectedRow<0)
        {
         ...
         Test testimonial = (Test)testimonialListJTable.getValueAt(selectedRow, 0);
