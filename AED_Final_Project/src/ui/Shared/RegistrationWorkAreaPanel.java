...
import backend.shared.SendMail;
...
import backend.enterprises.HelpEnterprise;
import backend.enterprises.HospEnterprise;
import backend.enterprises.SchoolEnterprise;
...
public class RegistrationWorkAreaPanel extends javax.swing.JPanel {
     ...
     */
    public RegistrationWorkAreaPanel(JPanel userProcessContainer, ConfSetup ecoSystem) {
        initComponents();
    ...
    private void createProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createProfileButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Please Enter valid gender ","warning", JOptionPane.WARNING_MESSAGE);
         ...
         Date dateOfBirthVal = new SimpleDateFormat("MM/dd/yyyy").parse(DobField.getText()) ;
            ...
            int age = Validations.calculateAge(dateOfBirthVal);
              ...
              if(isHelpSeeker.isSelected())
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as help seeker","warning", JOptionPane.WARNING_MESSAGE);
                    ...
                    Coverage helpSeekerNw = (Coverage)helpSeekerNetworkCombo.getSelectedItem();
                  ...
                  JOptionPane.showMessageDialog(null, "HelpSeeker Organization does not exist for the enterprise! "+enterprise.getName(),"warning", JOptionPane.WARNING_MESSAGE);
                   return;      
                    ...
                    for(Enterprises e : helpSeekerNw.getEnterpriseDirectory().getEnterpriseList())
                    {
                    ...
                    {
                        JOptionPane.showMessageDialog(null, "User Name already exists!, Please Enter valid user name","warning", JOptionPane.WARNING_MESSAGE);
                        organization.getPersonDirectory().getCustomerLsit().remove((Seeker)person);
                        return;
                    }
                    // To get help seeker org
                    
                    UserAcc userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new SeekerRole());
                    userAccount.setPerson(person);
                   userAccount.setNetwork((Coverage)helpSeekerNw);
                  
                    // Send Req to Supervisor for approval       
                    SupervisorTask request = new SupervisorTask();
                    request.setMessage(SupervisorTask.REQUEST_APPROVAL);
                    request.setSender(userAccount);
                    request.setStatus(SupervisorTask.REQUEST_SENT);
                    request.setRequestDate(new Date());
                    
                   // For Supervisor  
                  for(Enterprises e : helpSeekerNw.getEnterpriseDirectory().getEnterpriseList())
                  {
                      if(e instanceof HelpEnterprise)
                      {
                ...
                else if(isVolunteer.isSelected())
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Volunteer","warning", JOptionPane.WARNING_MESSAGE);
                    ...
                    return;     
                     ...
                     Coverage volNetwork = (Coverage)volNetworkCombo.getSelectedItem();
                  ...
                  person.setVolunteer(true);
                   ...
                   String userName = SendMail.generateUserName(lastNameField.getText());
                    if(!organization.getUserAccountDirectory().checkIfUsernameIsUnique(userName))
                    {
                        userName = SendMail.generateUserName(lastNameField.getText());
                    }
...
//                    }
                    ...
                    UserAcc userAccount = organization.getUserAccountDirectory().addUserAccount(userName,password , person, new VolunRole());
                    userAccount.setPerson(person);
                   ...
                   // For Supervisor  
                  for(Enterprises e : volNetwork.getEnterpriseDirectory().getEnterpriseList())
                  {
                      if(e instanceof HelpEnterprise)
                      {
                       for(Organization organization : e.getOrganizationDirectory().getOrganizationList())
                ...
                if(isDoctorRadioBtn.isSelected() )
                {
                 ...
                 JOptionPane.showMessageDialog(null, "Your age does not qualify as Dcotor","warning", JOptionPane.WARNING_MESSAGE);
                    ...
                    Coverage docNw = (Coverage)helpSeekerNetworkCombo.getSelectedItem();
                  ...
                  person = organization.getPersonDirectory().addPerson();
                    ...
                    for(Enterprises e : docNw.getEnterpriseDirectory().getEnterpriseList())
                    {
                     for(UserAcc ua : e.getUserAccountDirectory().getUserAccountList())
                    {
                        if(ua.getUserName().equals(userName))
                    ...
                    UserAcc userAccount = organization.getUserAccountDirectory().addUserAccount(userName, password, person, new DocRole());
                    userAccount.setPerson(person);
    ...
    public void getEnterprise(Coverage network)
    {
          try
                {
                 for (Coverage n : ecoSystem.getNetworkList())
                    {
                    if(n.getCity().equals(network.getCity()))   
                    {  
                   for(Enterprises e : n.getEnterpriseDirectory().getEnterpriseList())
                      {
                           ...
                           else if(e instanceof HelpEnterprise && isHelpSeeker.isSelected())
                           {
                             this.enterprise = e;
                              network = n;
                            }
                            else if(e instanceof HospEnterprise && isDoctorRadioBtn.isSelected())
                           {
                             this.enterprise = e;
                              network = n;
                           }
    ...
    public void getOrganization(String orgVal, Enterprises e){
     ...
     for (Organization organization : e.getOrganizationDirectory().getOrganizationList()){
       ...
       if(orgVal.equals("Volunteer") && organization instanceof Volunteers)
        {
              this.organization = organization;
              this.personDirectory = organization.getPersonDirectory();
        
        }     
     else if(orgVal.equals("HelpSeeker") && organization instanceof OrganizationSeeker)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             }  
       
       else if(orgVal.equals("Doctor") && organization instanceof Doctor)
             {
               this.organization = organization;
               this.personDirectory = organization.getPersonDirectory();
             } 
